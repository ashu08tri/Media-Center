...
const AdminLayout = ({ children }) => {
  ...
  const getCurrentPageName = () => {
    ...
    if (path === '/admin/advertisements') return 'Advertisements';
  ...
  return (
    <LayoutContainer>
      ...
      <Sidebar $isOpen={sidebarOpen}>
        <SidebarHeader>
          <div>
            <SidebarTitle>Kisan Satta</SidebarTitle>
        ...
        <SidebarNav>
          ...
          <NavItem>
            <NavLink 
              ...
              onClick={closeSidebarOnMobile}
              className={location.pathname.includes('/admin/subscribers') ? 'active' : ''}
            >
              <CardMembershipIcon /> Subscribers
            </NavLink>
          </NavItem>
           ...
           <NavItem>
            <NavLink 
              ...
              onClick={closeSidebarOnMobile}
              className={location.pathname.includes('/admin/advertisements') ? 'active' : ''}
            >
              <FeaturedPlayListIcon /> Ad. Requests
            </NavLink>
          </NavItem>
