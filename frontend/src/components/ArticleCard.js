...
const CardCategory = styled.div`
  ...
  a {
    color: ${props => props.variant === 'topPick' ? '#fff' : '#00712D'}; // The Hindu red or white for topPick
    text-decoration: none;
    ${props => props.variant === 'topPick' && css`
      background-color: #00712D; // The Hindu red
      padding: 3px 8px;
      border-radius: 3px;
    ...
    &:hover {
      ...
      ${props => props.variant === 'topPick' && css`
        background-color: #00712D; // Darker red on hover
      `}
    }
  }
`;
...
const CardTitle = styled.h3`
  ...
  a {
    ...
    text-decoration: none;
    &:hover {
      color: #00712D; // The Hindu red on hover
    }
  }
